...
export default function AntarkitaDesc() {
    const t = useTranslations("antarkita")
    return (
                ...
                >
                    <div className="relative group">
                        ...
                        <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 p-2 rounded-2xl border border-slate-700 group-hover:border-purple-500 transition-all duration-300 shadow-2xl">
                            <Image
                                src="https://toymskelmxthrqhijkel.supabase.co/storage/v1/object/public/project/antarkita.png"
                                alt="Dokumentasi Antarkita"
                                width={1200}
                                height={600}
